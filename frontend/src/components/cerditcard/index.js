...
import { INITIALSTATE, SUCCESSSTATE, FAILEDSTATE } from '../../constants'
...
export class CreditCardForm extends React.Component {
    ...
    constructor(props) {
        ...
        this.handleCCNameChange = this.handleCCNameChange.bind(this)
                ...
                <form onSubmit={this.handleSubmit}>
                    <div className="form-row">
                        <div className="col-lg-12 form-group">
                            ...
                            <input value={this.state.ccName} id="cc-name" name='cc-name' className="form-control" placeholder='Name on Card' onChange={this.handleCCNameChange} type='text' />
                        </div>
                    </div>
                    <div className="form-row">
                        <div className="col-lg-12 form-group">
...
export default function CreditCardInformation(props) {
    ...
    return (
        <StripeProvider apiKey="pk_test_LwL4RUtinpP3PXzYirX2jNfR">
            <Elements>
                <CCFormWithStripe toggle={props.toggle} operation={props.operation} />
            </Elements>
        </StripeProvider>
    )
}